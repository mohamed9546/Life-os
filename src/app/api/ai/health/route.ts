  ...
  try {
    ...
    return NextResponse.json({
      ...
      config: {
        ...
        monthlyBudgetGbp: config.monthlyBudgetGbp,
        estimatedSpendGbp: usage.estimatedSpendGbp,
        allowCloudInLocalMode: config.allowCloudInLocalMode,
        hasPrimaryApiKey: config.hasPrimaryApiKey,
        secondaryRuntime: config.secondaryRuntime,
        hasSecondaryApiKey: config.hasSecondaryApiKey,
