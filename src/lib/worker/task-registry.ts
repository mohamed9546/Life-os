...
export const DEFAULT_TASK_CONFIGS: WorkerTaskConfig[] = [
  ...
  {
    id: "fetch-jobsac-jobs",
    name: "Fetch jobs.ac.uk Jobs",
    enabled: true,
    minIntervalMs: 2 * 60 * 60 * 1000,
    dailyLimit: 6,
    burstWindowMs: 10 * 60 * 1000,
  ...
  {
    id: "fetch-totaljobs-jobs",
    name: "Fetch Totaljobs Jobs",
    enabled: true,
    minIntervalMs: 2 * 60 * 60 * 1000,
    dailyLimit: 6,
    burstWindowMs: 10 * 60 * 1000,
  ...
  {
    id: "fetch-weworkremotely-jobs",
    name: "Fetch We Work Remotely Jobs",
    enabled: false,
    minIntervalMs: 6 * 60 * 60 * 1000,
    dailyLimit: 2,
    burstWindowMs: 60 * 60 * 1000,
  ...
  {
    id: "fetch-guardianjobs-jobs",
    name: "Fetch Guardian Jobs",
    enabled: true,
    minIntervalMs: 4 * 60 * 60 * 1000,
    dailyLimit: 4,
...
export const FETCH_TASK_SOURCE_MAP: Record<string, string> = {
  ...
  "fetch-jobsac-jobs": "jobsac",
  "fetch-totaljobs-jobs": "totaljobs",
  ...
  "fetch-weworkremotely-jobs": "weworkremotely",
  "fetch-guardianjobs-jobs": "guardianjobs",
  "fetch-nhsjobs-jobs": "nhsjobs",
};
